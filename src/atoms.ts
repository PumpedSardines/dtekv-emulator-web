...
import { HexDisplays, LedStrip, Switches, UartCallback, CpuLoadCallback } from "./types";

// Need to add that as there for some reason?
export const store = createStore() as INTERNAL_PrdStore;
export const clockFrequencyAtom = atom(0);
...
export const switchesAtom = atom<Switches>(new Array(10).fill(false) as Switches);
export const ledStripAtom = atom<LedStrip>(new Array(10).fill(false) as LedStrip);
